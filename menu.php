...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <li><a href="galeria.php">Galeria Imagenes</a></li>
      <?php } ?>
      <?php if (!isset($_SESSION["UsuarioValidado"])){?>
        <li><a href="registro.php"><span class="glyphicon glyphicon-user"></span> Registrate</a></li>
      <?php } ?>
     <?php if (!isset($_SESSION["UsuarioValidado"])){?>
      <li><a href="entrar.php"><span class="glyphicon glyphicon-log-in"></span> Iniciar Sesión</a></li>
    <?php }else { ?>
 <li><a href="salir.php"><span class="glyphicon glyphicon-log-in "></span>&nbsp;Salir&nbsp;<?php
  echo $_SESSION["UsuarioValidado"][0]["Nombre"];
  //var_dump($_SESSION["UsuarioValidado"]);
   ?></a></li>
